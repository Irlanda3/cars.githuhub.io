...
//Get elements formt he DOM
const text = document.querySelector(".roof-text");
const roofImg = document.querySelector(".banner-img");

//Add a scroll event tot he document
window.addEventListener("scroll", () => {
  //Cuando el texto del elemento este animado
  if (text.classList.contains("aos-animate")) {
    //muestra la segunda imagen del roof
    roofImg.classList.add("roof-2");
  } else {
    // regresate a la primera imagen de roof
